...
public class ImageBasket extends UniverseShape {
    private double[] endPoint;

    public ImageBasket(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.BASQUET);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/canasta.png");
