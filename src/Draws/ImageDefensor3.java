...
public class ImageDefensor3 extends UniverseShape {
    private double[] endPoint;

    public ImageDefensor3(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("fill-color", getFillColor());
             this.getProperties().put("type", Sketch.ShapeType.DEFENSEPLAYER3);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/defensor3.png");
