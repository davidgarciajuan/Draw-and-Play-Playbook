...
public class ImageAtacante3 extends UniverseShape {
    private double[] endPoint;

    public ImageAtacante3(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.OFFENSEPLAYER3);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/atacante3.png");
