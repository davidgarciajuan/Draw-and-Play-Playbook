...
public class ImageDefensor extends UniverseShape {
    private double[] endPoint;

    public ImageDefensor(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.DEFENSEPLAYER);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/defensor.png");
