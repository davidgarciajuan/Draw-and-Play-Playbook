...
public class ImageAtacante9 extends UniverseShape {
    private double[] endPoint;

    public ImageAtacante9(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.OFFENSEPLAYER9);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/atacante9.png");
