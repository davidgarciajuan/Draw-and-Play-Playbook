...
public class ImageDefensor1 extends UniverseShape {
    private double[] endPoint;

    public ImageDefensor1(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("fill-color", getFillColor());
             this.getProperties().put("type", Sketch.ShapeType.DEFENSEPLAYER1);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/defensor1.png");
