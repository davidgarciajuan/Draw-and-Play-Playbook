...
public class ImageAtacante7 extends UniverseShape {
    private double[] endPoint;

    public ImageAtacante7(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.OFFENSEPLAYER7);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/atacante7.png");
