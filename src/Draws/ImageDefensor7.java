...
public class ImageDefensor7 extends UniverseShape {
    private double[] endPoint;

    public ImageDefensor7(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("fill-color", getFillColor());
             this.getProperties().put("type", Sketch.ShapeType.DEFENSEPLAYER7);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/defensor7.png");
