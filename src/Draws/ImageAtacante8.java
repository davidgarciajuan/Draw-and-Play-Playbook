...
public class ImageAtacante8 extends UniverseShape {
    private double[] endPoint;

    public ImageAtacante8(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.OFFENSEPLAYER8);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/atacante8.png");
