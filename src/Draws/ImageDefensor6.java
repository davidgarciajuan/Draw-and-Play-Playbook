...
public class ImageDefensor6 extends UniverseShape {
    private double[] endPoint;

    public ImageDefensor6(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("fill-color", getFillColor());
             this.getProperties().put("type", Sketch.ShapeType.DEFENSEPLAYER6);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/defensor6.png");
