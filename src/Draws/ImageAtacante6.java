...
public class ImageAtacante6 extends UniverseShape {
    private double[] endPoint;

    public ImageAtacante6(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.OFFENSEPLAYER6);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/atacante6.png");
