...
public class ImageDefensor5 extends UniverseShape {
    private double[] endPoint;

    public ImageDefensor5(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("fill-color", getFillColor());
             this.getProperties().put("type", Sketch.ShapeType.DEFENSEPLAYER5);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/defensor5.png");
