...
public class ImageAtacante extends UniverseShape {
    private double[] endPoint;

    public ImageAtacante(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.OFFENSEPLAYER);
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/atacante.png");
