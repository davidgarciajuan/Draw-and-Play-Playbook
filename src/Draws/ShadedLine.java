...
public class ShadedLine extends UniverseShape {

    private double[] endPoint = new double[2];

    public ShadedLine(double[] startPoint, double[] endPoint, Color color, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.PASSLINE);
    }
