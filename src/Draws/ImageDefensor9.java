...
public class ImageDefensor9 extends UniverseShape {
    private double[] endPoint;

    public ImageDefensor9(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("fill-color", getFillColor());
             this.getProperties().put("type", Sketch.ShapeType.DEFENSEPLAYER9);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/defensor9.png");
