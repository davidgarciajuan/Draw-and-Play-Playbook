...
public class ImageCesta extends UniverseShape {
    private double[] endPoint;

    public ImageCesta(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.CESTA);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/cesta.png");
