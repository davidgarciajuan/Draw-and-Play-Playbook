...
public class ImageDefensor2 extends UniverseShape {
    private double[] endPoint;

    public ImageDefensor2(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("fill-color", getFillColor());
             this.getProperties().put("type", Sketch.ShapeType.DEFENSEPLAYER2);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/defensor2.png");
