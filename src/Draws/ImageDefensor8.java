...
public class ImageDefensor8 extends UniverseShape {
    private double[] endPoint;

    public ImageDefensor8(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("fill-color", getFillColor());
             this.getProperties().put("type", Sketch.ShapeType.DEFENSEPLAYER8);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/defensor8.png");
