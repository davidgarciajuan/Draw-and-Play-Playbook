...
public class ImageAtacante5 extends UniverseShape {
    private double[] endPoint;

    public ImageAtacante5(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.OFFENSEPLAYER5);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/atacante5.png");
