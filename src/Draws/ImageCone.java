...
public class ImageCone extends UniverseShape {
    private double[] endPoint;

    public ImageCone(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.CONE);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/cono.png");
