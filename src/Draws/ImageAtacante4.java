...
public class ImageAtacante4 extends UniverseShape {
    private double[] endPoint;

    public ImageAtacante4(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.OFFENSEPLAYER4);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/atacante4.png");
