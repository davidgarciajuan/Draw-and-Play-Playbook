...
public class ImageAtacante2 extends UniverseShape {
    private double[] endPoint;

    public ImageAtacante2(double[] startPoint, double[] endPoint, Color strokeColor, Color fillColor, double strokeWidth) {
        super();
        ...
        this.getProperties().put("type", Sketch.ShapeType.OFFENSEPLAYER2);
    }
    ...
    public void draw() {
        ...
        Image img = new Image ("/Images/atacante2.png");
